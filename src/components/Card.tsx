...
export const CardHeader = ({ children }: CardHeaderProps) => (
  <div style={{ padding: '1.25rem 1.5rem', borderBottom: '1px solid var(--border)' }}>{children}</div>
);
...
export const CardFooter = ({ children }: CardFooterProps) => (
  <div style={{ padding: '1rem 1.5rem', borderTop: '1px solid var(--border)' }}>{children}</div>
);
